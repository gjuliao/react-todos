...
**[React Todos]** Is a react app to create, edit and delete Todo's, using local storage.
...
1. Download the **Zip** file or clone the repo with:
   `bash git clone git@github.com:gjuliao/react_todos.git`
...
Feel free to check the [issues page](https://github.com/gjuliao/react_todos/issues).
